      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {useCases.map(({ titleKey, descKey, statKey, Icon, gradient }) => (
            <div
              key={titleKey}
              className="group relative flex flex-col rounded-xl border border-[#E8DED1] bg-white p-6 transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#8C4A2F]/5"
            >
              <div
