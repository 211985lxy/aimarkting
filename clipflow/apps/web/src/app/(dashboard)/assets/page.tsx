...
const avatarStatusConfig: Record<
  string,
...
type AssetType = "image" | "video" | "music";
...
interface AvatarPreviewVoice extends PublicVoice {
  source: "public" | "mine";
}

interface AvatarPreviewSelection {
  avatar: {
    id: string;
    name: string;
    coverUrl: string;
...
async function fetchPublicAssets(): Promise<{
...
function buildUserVoicesFromAssets(assets: ApiAsset[]): UserVoice[] {
  return assets
...
function getLinkedVoiceForAvatar(
  avatar: ApiAvatar,
...
function getRecommendedVoiceId(
  voices: PublicVoice[],
  gender?: string,
): string | null {
...
function dedupeVoices(voices: AvatarPreviewVoice[]): AvatarPreviewVoice[] {
...
function buildPersonalAvatarVoices(
  avatar: ApiAvatar,
  userVoices: UserVoice[],
...
function getDefaultVoiceIdForPersonalAvatar(
  avatar: ApiAvatar,
  voices: AvatarPreviewVoice[],
): string | null {
  if (
