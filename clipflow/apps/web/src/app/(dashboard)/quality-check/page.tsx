          ...
          <div className="space-y-3">
            ...
            {historyLoading ? (
              ...
              <div className="rounded-xl border border-dashed border-border/80 p-8 text-center bg-muted/5">
                <p className="text-xs text-muted-foreground">还没有生成过文案，建议先去 <Link href="/aim" className="text-primary font-semibold hover:underline">AIM一键生成</Link> 创作您的专属文案。</p>
              </div>
            ) : (
                ...
                <div className="py-12 px-6 text-center space-y-4 flex flex-col items-center justify-center flex-1">
                  ...
                  <div className="space-y-1 max-w-sm">
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      检测引擎完全采用沙箱计算，在左侧编辑区输入您的内容或导入最近生成的历史，点击「开始多维质量检测」即刻出具四维门控报告。
                    </p>
                  </div>
