    ...
    <div className="space-y-6 pb-10">
      <section className="space-y-3">
        <div className="flex flex-wrap items-center gap-2">
          <h1 className="text-2xl font-bold tracking-tight">今天推进哪个 IP 营销全案？</h1>
          <Badge className="badge-gold border-none px-2 py-0.5 rounded-sm text-xs">极简交付版</Badge>
        </div>
        <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground">
          第一版只保留一条主路径：IP营销全案、AI内容工作台、内容资产沉淀。其他高级能力先收起来，先把员工每天要做的事跑顺。
        </p>
      </section>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="border-primary/20 bg-gradient-to-br from-primary/[0.05] to-amber-500/[0.02]">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm leading-relaxed text-muted-foreground">
              接到客户后，先建全案。后面的文案、拍摄交接单和交付状态都归到这个全案下面。
            </p>
        ...
        <Card className="border-primary/20 bg-gradient-to-br from-primary/[0.05] to-amber-500/[0.02]">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm leading-relaxed text-muted-foreground">
              把公众号文案、口播稿、朋友圈粘进去，AI内容工作台帮你去 AI 味、提炼观点、强化开头。
            </p>
            <Button className="w-full" nativeButton={false} render={<Link href="/aim" />}>
              去改文案
              <ArrowRight className="h-4 w-4" />
            </Button>
          </CardContent>
        ...
        <Card className="border-primary/20 bg-gradient-to-br from-primary/[0.05] to-amber-500/[0.02]">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm leading-relaxed text-muted-foreground">
              输入公众号文案、客户问题或老板经验，输出短视频脚本、朋友圈和社群运营文案。
            </p>
            <Button className="w-full" nativeButton={false} render={<Link href="/aim" />}>
              去写脚本
              <ArrowRight className="h-4 w-4" />
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        ...
        <Card>
          <CardHeader className="border-b pb-3">
            <CardTitle className="text-base">第一版只做这 3 件事</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3 p-4 text-sm text-muted-foreground">
            <p><span className="font-semibold text-foreground">1. IP营销全案：</span>把每个客户的定位、资料和内容隔离清楚。</p>
              <p><span className="font-semibold text-foreground">2. AI内容工作台：</span>改文案、生成脚本、出拍摄交接单。</p>
            <p><span className="font-semibold text-foreground">3. 状态推进：</span>让员工知道下一步该审核、拍摄、剪辑还是发布。</p>
          </CardContent>
        </Card>
      </div>
    </div>
