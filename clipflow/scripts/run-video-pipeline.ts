...
async function main() {
  ...
  console.log("=== ClipFlow Video Production Pipeline ===\n")
  ...
  const scriptContent = "大家好，欢迎来到ClipFlow短视频制作平台！我们致力于帮助每一位创作者，轻松高效地制作出专业级的短视频内容。无论你是个人品牌打造者，还是小企业主，ClipFlow都能为你提供一站式的视频制作解决方案。让我们一起，用视频的力量，讲述你的故事！"
