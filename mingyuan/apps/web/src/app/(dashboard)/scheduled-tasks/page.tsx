...
const TASKS = [
  ...
  },
  {
    name: "增强任务轮询",
    schedule: "高频轮询",
    endpoint: "/api/cron/poll-enhancements",
    desc: "同步 4K 增强等后处理任务状态。",
    status: "已接入",
  },
  {
    name: "交付资产回填",
    schedule: "按 cron 配置",
    endpoint: "/api/cron/backfill-delivery",
    desc: "补齐视频任务交付资产状态。",
    status: "已接入",
  },
  {
    name: "素材转存",
    schedule: "按 cron 配置",
    endpoint: "/api/cron/pexels-transfer",
    desc: "把外部素材转存为稳定资产。",
    status: "已接入",
  },
  {
