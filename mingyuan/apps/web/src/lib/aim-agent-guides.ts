...
export const AIM_AGENT_GUIDES: Record<AimAgentId, AimAgentGuide> = {
  content_producer: {
    ...
    defaultInstruction: "去 AI 味，保留真人表达的犹豫、判断和具体细节，少用套话。先判断用户要的是改写、对标再创作、追热点、热点口播、爆款口播、参考同行文案拆解、仿写但不抄、获客文案、观点表达还是核心内容一键拆解；凡是命中热点口播 / 爆款口播 / 参考同行文案 / 拆爆款 / 仿写但不抄 / 短视频脚本，就优先按「热点口播脚本生成」路由处理，再输出适合发布的内容交付物。",
    quickPrompts: [
