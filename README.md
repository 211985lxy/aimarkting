...
2. **AIM 一键生成 (`/aim`)** - 升级为「智能体货架」，内置定位诊断、短视频获客、公众号深度长文和朋友圈成交 4 个营销智能体卡片，支持 Quick Prompts 推荐素材一键填充，统一生成营销交付物与诊断报告。
...
- `/aim` 升级为「智能体货架」，提供定位诊断、短视频获客、公众号深度长文、朋友圈成交 4 个智能体。
- 企业知识库保存在 `KnowledgeEntry`，支持老板经验、产品卖点、客户痛点、项目案例的无缝联动检索。
- 生成记录保存在 `AimGeneration`，集成视频脚本、公众号长文、朋友圈文案与诊断报告等营销资产交付。
...
- **AIM 智能体货架**：将原“AI内容工作台”升级为“智能体货架 + 统一生成台”。内置 4 个专属智能体卡片（商业定位诊断、IP短视频获客、公众号深度长文、朋友圈成交）与 Quick Prompts 推荐问题一键填充，并将原始文案（`raw_copy`）统一映射呈现为“诊断报告”。
